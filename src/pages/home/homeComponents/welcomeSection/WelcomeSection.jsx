...
const WelcomeSection = () => {
    return (
        <div className='py-10 md:py-14 container mx-auto'>
            <h1 className='text-center text-3xl md:text-[40px] font-semibold '>Welcome to Our Store</h1>
            <p className='max-w-[85%] md:max-w-[80%] mx-auto text-center text-[#666666]  text-lg font-jost mt-5 md:mt-8'>
