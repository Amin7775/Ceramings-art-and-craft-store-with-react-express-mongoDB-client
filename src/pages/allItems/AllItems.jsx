                ...
                {loadedData?.length != 0 &&
                  loadedData?.map((singleData) => (
                    <tr key={singleData._id}>
                      <th>
                        <label>
                          <p className="text-lg text-center">{(serial = serial + 1)}</p>
                        </label>
                      </th>
                      <td>
                      ...
                      <td className="hidden sm:table-cell">{singleData?.subcategory_Name}</td>
                      <td className="hidden sm:table-cell">{singleData?.price}</td>
                      <td className="hidden sm:table-cell">{singleData?.stockStatus}</td>
                      <td>
